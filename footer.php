                ...
                <div class="container paddingtop50">
                    <div class="row">
                        ...
                        <? } else { ?>
                            <label>CONTACT</label>
                        <?php } ?>
                            <table class="margintop10" style=width:100%>
                                <tr>
                                    <th class="thfooter">
                                        <p><i class="material-icons verticalalign">phone</i>
                                            <?php if($lenguaje=='es'){ ?>
                                                TELÉFONO:
                                            <? } else { ?>
                                                PHONE:
                                    ...
                                    <th>
                                        <p>0251-2372671 (Master)</p>
                                    </th>
                                </tr>
                                <tr>
                                    <th class="thfooter">
                                        <p><i class="material-icons verticalalign">inbox</i> FAX:</p>
                                    </th>
                                    <th>
                                        <p>0251-2370334</p>
                                        <p>0251-2375186</p>
                                ...
                                <tr>
                                    <th class="thfooter">
                                        <p><i class="material-icons verticalalign">location_on</i>
                                            <?php if($lenguaje=='es'){ ?>
                                                UBICACIÓN:
                                            <? } else { ?>
                                                DIRECTION:
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <p>ventas@mastercircuito.com</p>
                                        <p>mastercircuitoca@cantv.net</p>
                                        <p>compras@mastercircuito.com</p>
                                        <p>mastercircuitoventas@gmail.com</p>
                                    </th> 
                                </tr>
                            </table>
                        </div>
		...
		<div class="footer grey darken-4">
            <div class="container">
                <div class="row marginbot0">
                    <div class="col-md-12">
                        <p class="copyright center-align small"> Master Circuito CA | RIF: J-08529970-0 | Todos los Derechos Reservados | Desarrollado por <a href="http://bitcodeweb.com/" target="_blank"><img src="<?php echo get_bloginfo('template_directory');?>/img/logomini.png"></a></p>
                    </div>
                </div>
            </div>
        </div>
